...
genre_barplot <- barplot(frequencies, col="#69b3a2", names.arg=c("Comedy","Horror","Romance","Action","Thriller", "Drama", "Mystery", "Crime", "Animation", "Adventure", "Fantasy"), las=2);
genre_barplot;

# runtime
runtimeHistogram <- hist(movies$runtime, col="#a2dcf5");
runtimeHistogram;
